    ...
    public function store(Request $request, $id = null)
    {
        ...
        if ($validator->fails()) {
          ...
          if (!$file->isValid()) {
            ...
            //
            $path_old = 'uploads/images/';
            $path_original = 'uploads/images/original/';
            $path_medium = 'uploads/images/medium/';
            $path_small = 'uploads/images/small/';



            $file->move($path_original, $filename); // Move the original one first

            Img::make($path_original.$filename)->resize(225,null,
              function ($constraint) {
            ...
            $images->title = $title;
            $images->desc = $desc;
            $images->path = 'uploads/images/original/'.$filename;
            $images->save();
